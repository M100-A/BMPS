...
int gamelogic00_scene0000 (int iSubSceneId, char cSubFlag)
{
    ...
    if (iRet != 0) return iRet;
    iRet = mutils_addToCommandList ("About Bunny, Mayoress, Prostitute & Succubus", 2, 0);
    if (iRet != 0) return iRet;
