...
int gamelogic01_scene1002 (int iSubSceneId, char cSubFlag)
{
    ...
    case 1:
        if (cSubFlag == 0)
        {
            iRet = mutils_addToDialogBuffer (">Easy\n\n");
            if (iRet != 0) return iRet;
        }
    ...
    case 2:
        if (cSubFlag == 0)
        {
            iRet = mutils_addToDialogBuffer (">Medium\n\n");
            if (iRet != 0) return iRet;
        }
    ...
    default:
        if (cSubFlag == 0)
        {
            iRet = mutils_addToDialogBuffer (">Hard\n\n");
            if (iRet != 0) return iRet;
        }
